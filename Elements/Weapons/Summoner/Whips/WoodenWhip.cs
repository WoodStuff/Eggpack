...
namespace eggpack.Elements.Weapons.Summoner.Whips
{
    public class WoodenWhip : ModItem
    {
        ...
        public void WhipDefaults(int projectileId, int dmg, float kb, float shootspeed, bool reuse = false, int animationTotalTime = 30)
        {
        ...
        public class WoodenWhipProjectile : ModProjectile
        {
            public override void SetStaticDefaults()
            {
                ...
                DisplayName.SetDefault("WoodenWhipProjectile");
            }
            public override void SetDefaults()
            {
                Projectile.width = 18;
